"""
Django settings for agdss project.
...
WSGI_APPLICATION = 'agdss.wsgi.application'
...
DATABASES = {
    'default': {
            ...
            'USER': 'aguser',
            'PASSWORD': 'aguser',
            'HOST': '', #'HOST': 'localhost',                      # Empty for localhost through domain sockets or           '127.0.0.1' for localhost through TCP.
